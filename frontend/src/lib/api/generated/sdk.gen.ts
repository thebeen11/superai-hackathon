 ...
 */
export const listIndicatorHistory = <ThrowOnError extends boolean = false>(options?: Options<ListIndicatorHistoryData, ThrowOnError>): RequestResult<ListIndicatorHistoryResponses, ListIndicatorHistoryErrors, ThrowOnError> => (options?.client ?? client).get<ListIndicatorHistoryResponses, ListIndicatorHistoryErrors, ThrowOnError>({ url: '/api/indicators/history', ...options });
